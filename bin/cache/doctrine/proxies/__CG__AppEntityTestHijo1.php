 ...
 */
class Hijo1 extends \App\Entity\Test\Hijo1 implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'childjr1' => [parent::class, 'childjr1', null],
        "\0".parent::class."\0".'childjr2' => [parent::class, 'childjr2', null],
        ...
        'childjr1' => [parent::class, 'childjr1', null],
        'childjr2' => [parent::class, 'childjr2', null],
