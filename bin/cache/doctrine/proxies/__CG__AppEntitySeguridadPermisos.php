 ...
 */
class Permisos extends \App\Entity\Seguridad\Permisos implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'accion' => [parent::class, 'accion', null],
        ...
        "\0".parent::class."\0".'tipoUsuarioPermisos' => [parent::class, 'tipoUsuarioPermisos', null],
        'accion' => [parent::class, 'accion', null],
        ...
        'tipoUsuarioPermisos' => [parent::class, 'tipoUsuarioPermisos', null],
    ];
