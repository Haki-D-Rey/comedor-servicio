...
namespace Proxies\__CG__\App\Entity\Seguridad;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class TipoUsuarioPermisos extends \App\Entity\Seguridad\TipoUsuarioPermisos implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'permiso' => [parent::class, 'permiso', null],
        "\0".parent::class."\0".'tipoUsuario' => [parent::class, 'tipoUsuario', null],
        ...
        'permiso' => [parent::class, 'permiso', null],
        'tipoUsuario' => [parent::class, 'tipoUsuario', null],
