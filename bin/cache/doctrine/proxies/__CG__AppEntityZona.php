 ...
 */
class Zona extends \App\Entity\Zona implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'zonaUsuarios' => [parent::class, 'zonaUsuarios', null],
        ...
        'zonaUsuarios' => [parent::class, 'zonaUsuarios', null],
    ];
