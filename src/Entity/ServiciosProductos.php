...
#[ORM\Entity]
#[ORM\Table(name: 'catalogo.servicios_productos')]
class ServiciosProductos
{
    ...
    /**
     * One ServicioProducto has Many ServiciosProductosDetalles.
     * @var Collection<int, ServiciosProductosDetalles>
     */
    #[ORM\OneToMany(targetEntity: ServiciosProductosDetalles::class, mappedBy: 'serviciosProductos')]
