...
#[ORM\Entity]
#[ORM\Table(name: 'sistemas', schema:'catalogo')]
class Sistemas
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
...
/**
     * One Sistema has Many ServiciosProductosDetalles.
     * @var Collection<int, ServiciosProductosDetalles>
     */
    #[ORM\OneToMany(targetEntity: ServiciosProductosDetalles::class, mappedBy: 'sistemas')]
